    ...
    <section id="projects" className="py-20 px-4">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        {projects.map((project, projectIndex) => (
          <div key={projectIndex} className="space-y-16">
            {/* 项目概览卡片 */}
            <Card className="card-shadow border-2">
              <CardHeader className="text-center">
                <CardTitle className="text-3xl">{project.name}</CardTitle>
                <CardDescription className="text-lg">{project.oneLiner}</CardDescription>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {project.problem.map((pain, index) => (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {project.process.map((insight, index) => (
            ...
            {projectIndex < projects.length - 1 && (
              <div className="border-t-2 border-dashed border-border pt-16"></div>
            )}
          </div>
        ))}
